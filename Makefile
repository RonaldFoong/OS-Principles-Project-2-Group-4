...
FIRSTFIT_OBJS = $(OBJ_DIR)/firstfit.o $(OBJ_DIR)/firstfit_lib.o $(OBJ_DIR)/alloc_list.o $(OBJ_DIR)/chunk_size_of.o
BESTFIT_OBJS = $(OBJ_DIR)/bestfit.o $(OBJ_DIR)/bestfit_lib.o $(OBJ_DIR)/alloc_list.o $(OBJ_DIR)/chunk_size_of.o
QUICKFIT_OBJS = $(OBJ_DIR)/quickfit.o $(OBJ_DIR)/quickfit_lib.o $(OBJ_DIR)/alloc_list.o $(OBJ_DIR)/chunk_size_of.o
